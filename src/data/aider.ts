...
export const aider: AgentDef = {
  ...
  release: {
    ...
    source: 'https://pypi.org/pypi/aider-chat/json',
  },
  prompt: '$',
  tagline: {
  ...
  categories: [
    {
      ...
      entries: [
        ...
        ...quickEntries('flag', 'aider', [
          ['--4', undefined, 'Use the deprecated GPT-4 model shortcut', '使用已弃用的 GPT-4 模型快捷方式'],
          ['--35turbo', undefined, 'Use the deprecated GPT-3.5 Turbo model shortcut', '使用已弃用的 GPT-3.5 Turbo 模型快捷方式'],
          ['--4-turbo', undefined, 'Use the deprecated GPT-4 Turbo model shortcut', '使用已弃用的 GPT-4 Turbo 模型快捷方式'],
          ['--4o', undefined, 'Use the deprecated GPT-4o model shortcut', '使用已弃用的 GPT-4o 模型快捷方式'],
          ['--add-gitignore-files', undefined, 'Include files matched by .gitignore in aider ignore processing', '把 .gitignore 匹配项加入 Aider 忽略规则'],
          ['--aiderignore', '<file>', 'Choose the aider ignore file', '指定 Aider 忽略规则文件'],
          ['--alias', '<alias:model>', 'Add a model alias; may be repeated', '添加模型别名，可重复传入'],
          ['--analytics', undefined, 'Enable or disable anonymous analytics', '启用匿名使用分析'],
          ['--analytics-disable', undefined, 'Permanently disable analytics', '永久关闭匿名使用分析'],
          ['--analytics-log', '<file>', 'Write analytics events to a log file', '把分析事件写入日志文件'],
          ['--analytics-posthog-host', '<url>', 'Override the PostHog analytics host', '覆盖 PostHog 分析服务地址'],
          ['--analytics-posthog-project-api-key', '<key>', 'Override the PostHog project API key', '覆盖 PostHog 项目 API Key'],
          ['--anthropic-api-key', '<key>', 'Set the Anthropic API key', '设置 Anthropic API Key'],
          ['--apply', '<file>', 'Apply edits from a file instead of starting chat', '从文件应用编辑结果，不进入聊天'],
          ['--apply-clipboard-edits', undefined, 'Apply edits found on the clipboard', '应用剪贴板中的编辑内容'],
          ['--assistant-output-color', '<color>', 'Set the assistant output color', '设置助手输出颜色'],
          ['--attribute-author', undefined, 'Attribute git commits to the author', '在 Git 提交中标注作者'],
          ['--attribute-co-authored-by', undefined, 'Add a Co-authored-by trailer to commits', '在提交中加入 Co-authored-by 标记'],
          ['--attribute-commit-message-author', undefined, 'Attribute commit messages to the author', '在提交信息中标注作者'],
          ['--attribute-commit-message-committer', undefined, 'Attribute commit messages to the committer', '在提交信息中标注提交者'],
          ['--attribute-committer', undefined, 'Attribute git commits to the committer', '在 Git 提交中标注提交者'],
          ['--auto-accept-architect', undefined, 'Automatically apply architect-mode implementation edits', '自动接受并应用 Architect 模式的实现改动'],
          ['--auto-commits', undefined, 'Automatically commit aider changes', '自动提交 Aider 产生的改动'],
          ['--auto-lint', undefined, 'Run lint automatically after edits', '每次编辑后自动运行 lint'],
          ['--auto-test', undefined, 'Run tests automatically after edits', '每次编辑后自动运行测试'],
          ['--cache-keepalive-pings', '<count>', 'Keep the prompt cache warm with periodic pings', '定期发送保活请求维持提示词缓存'],
          ['--chat-history-file', '<file>', 'Choose the Markdown chat history file', '指定 Markdown 聊天历史文件'],
          ['--chat-language', '<language>', 'Ask aider to use a specific chat language', '指定 Aider 对话使用的语言'],
          ['--check-model-accepts-settings', undefined, 'Validate model support for configured API settings', '检查模型是否支持已配置的 API 参数'],
          ['--check-update', undefined, 'Check PyPI for aider updates', '检查 PyPI 上是否有 Aider 更新'],
          ['--code-theme', '<theme>', 'Choose the Pygments code theme', '选择代码高亮主题'],
          ['--commit-language', '<language>', 'Generate commit messages in a specific language', '指定 Git 提交信息语言'],
          ['--commit-prompt', '<prompt>', 'Customize the commit-message prompt', '自定义生成提交信息的提示词'],
          ['--completion-menu-bg-color', '<color>', 'Set the completion menu background color', '设置补全菜单背景色'],
          ['--completion-menu-color', '<color>', 'Set the completion menu text color', '设置补全菜单文字颜色'],
          ['--completion-menu-current-bg-color', '<color>', 'Set the selected completion background color', '设置补全菜单当前选项背景色'],
          ['--completion-menu-current-color', '<color>', 'Set the selected completion text color', '设置补全菜单当前选项文字颜色'],
          ['--copy-paste', undefined, 'Enable clipboard copy and paste support', '启用剪贴板复制粘贴支持'],
          ['--deepseek', undefined, 'Use the deprecated DeepSeek model shortcut', '使用已弃用的 DeepSeek 模型快捷方式'],
          ['--detect-urls', undefined, 'Offer to add URLs found in chat messages', '检测消息中的 URL 并提示抓取'],
          ['--dirty-commits', undefined, 'Allow commits when the repository already has changes', '允许在仓库已有改动时继续自动提交'],
          ['--disable-playwright', undefined, 'Never install or use Playwright for web scraping', '禁止安装或使用 Playwright 抓取网页'],
          ['--editor', '<command>', 'Choose the editor used by /editor', '指定 /editor 命令调用的编辑器'],
          ['--editor-edit-format', '<format>', 'Choose the editor model edit format', '指定编辑器模型的改动格式'],
          ['--encoding', '<encoding>', 'Set input and output encoding', '设置输入输出编码'],
          ['--env-file', '<file>', 'Choose the .env file to load', '指定要加载的 .env 文件'],
          ['--exit', undefined, 'Perform startup checks and exit before chat', '完成启动检查后退出，不进入聊天'],
          ['--fancy-input', undefined, 'Enable the rich multiline input UI', '启用增强型多行输入界面'],
          ['--git', undefined, 'Enable Git repository integration', '启用 Git 仓库集成'],
          ['--git-commit-verify', undefined, 'Run Git commit hooks and signature verification', '执行 Git 提交钩子与签名校验'],
          ['--gitignore', undefined, 'Manage the aider entries in .gitignore', '管理 .gitignore 中的 Aider 条目'],
          ['--haiku', undefined, 'Use the deprecated Claude Haiku model shortcut', '使用已弃用的 Claude Haiku 模型快捷方式'],
          ['--input-history-file', '<file>', 'Choose the input history file', '指定输入历史文件'],
          ['--install-main-branch', undefined, 'Install aider from the main branch', '从主分支安装 Aider'],
          ['--just-check-update', undefined, 'Check for updates and report status through the exit code', '只检查更新，并通过退出码报告结果'],
          ['--light-mode', undefined, 'Use colors suited to light terminal backgrounds', '使用适合浅色终端的配色'],
          ['--line-endings', '<platform|lf|crlf>', 'Choose line endings for edited files', '指定编辑文件使用的换行格式'],
          ['--lint-cmd', '<language:command>', 'Configure a lint command; may be repeated', '为不同语言配置 lint 命令，可重复传入'],
          ['--llm-history-file', '<file>', 'Log the raw LLM conversation to a file', '把原始模型对话写入日志文件'],
          ['--load', '<file>', 'Run slash commands from a file at startup', '启动时执行文件中的斜杠命令'],
          ['--map-multiplier-no-files', '<number>', 'Scale repo-map tokens when no files are selected', '未选择文件时调整仓库地图 Token 倍率'],
          ['--map-refresh', '<mode>', 'Choose when the repository map refreshes', '设置仓库地图刷新策略'],
          ['--max-chat-history-tokens', '<count>', 'Set the soft limit before chat-history summarization', '设置触发聊天历史摘要的 Token 软上限'],
          ['--message-file', '<file>', 'Read the initial message from a file', '从文件读取初始消息'],
          ['--mini', undefined, 'Use the deprecated GPT-4o Mini model shortcut', '使用已弃用的 GPT-4o Mini 模型快捷方式'],
          ['--model-metadata-file', '<file>', 'Load model context and cost metadata', '加载模型上下文窗口与成本元数据'],
          ['--model-settings-file', '<file>', 'Load model settings for unknown models', '为未知模型加载设置文件'],
          ['--multiline', undefined, 'Enable multiline input mode', '启用多行输入模式'],
          ['--notifications', undefined, 'Enable completion notifications', '启用任务完成通知'],
          ['--notifications-command', '<command>', 'Run a custom notification command', '设置自定义通知命令'],
          ['--o1-mini', undefined, 'Use the deprecated o1-mini model shortcut', '使用已弃用的 o1-mini 模型快捷方式'],
          ['--o1-preview', undefined, 'Use the deprecated o1-preview model shortcut', '使用已弃用的 o1-preview 模型快捷方式'],
          ['--openai-api-base', '<url>', 'Set the OpenAI-compatible API base URL', '设置 OpenAI 兼容 API 基础地址'],
          ['--openai-api-deployment-id', '<id>', 'Set the deprecated OpenAI deployment ID', '设置已弃用的 OpenAI 部署 ID'],
          ['--openai-api-key', '<key>', 'Set the OpenAI API key', '设置 OpenAI API Key'],
          ['--openai-api-type', '<type>', 'Set the deprecated OpenAI API type', '设置已弃用的 OpenAI API 类型'],
          ['--openai-api-version', '<version>', 'Set the deprecated OpenAI API version', '设置已弃用的 OpenAI API 版本'],
          ['--openai-organization-id', '<id>', 'Set the deprecated OpenAI organization ID', '设置已弃用的 OpenAI 组织 ID'],
          ['--opus', undefined, 'Use the deprecated Claude Opus model shortcut', '使用已弃用的 Claude Opus 模型快捷方式'],
          ['--pretty', undefined, 'Enable colorized terminal output', '启用彩色美化终端输出'],
          ['--restore-chat-history', undefined, 'Restore messages from the previous chat history', '恢复上一次聊天历史中的消息'],
          ['--set-env', '<name=value>', 'Set an environment variable; may be repeated', '设置环境变量，可重复传入'],
          ['--shell-completions', '<shell>', 'Install or print shell completions', '安装或输出 Shell 补全脚本'],
          ['--show-diffs', undefined, 'Show diffs when committing changes', '提交改动时显示 diff'],
          ['--show-model-warnings', undefined, 'Require models with known metadata', '显示模型元数据与兼容性警告'],
          ['--show-prompts', undefined, 'Print system prompts and exit', '打印系统提示词后退出'],
          ['--show-release-notes', undefined, 'Show release notes after an update', '更新后显示发行说明'],
          ['--show-repo-map', undefined, 'Print the repository map and exit', '打印仓库地图后退出'],
          ['--skip-sanity-check-repo', undefined, 'Skip repository safety checks', '跳过仓库安全性检查'],
          ['--sonnet', undefined, 'Use the deprecated Claude Sonnet model shortcut', '使用已弃用的 Claude Sonnet 模型快捷方式'],
          ['--stream', undefined, 'Stream model responses as they arrive', '流式显示模型响应'],
          ['--suggest-shell-commands', undefined, 'Ask before suggesting shell commands', '允许建议并确认 Shell 命令'],
          ['--test-cmd', '<command>', 'Choose the command used to run tests', '指定运行测试的命令'],
          ['--timeout', '<seconds>', 'Set the API request timeout', '设置 API 请求超时时间'],
          ['--tool-error-color', '<color>', 'Set the tool error color', '设置工具错误输出颜色'],
          ['--tool-output-color', '<color>', 'Set the tool output color', '设置工具普通输出颜色'],
          ['--tool-warning-color', '<color>', 'Set the tool warning color', '设置工具警告输出颜色'],
          ['--upgrade', undefined, 'Upgrade aider to the latest PyPI release', '升级到 PyPI 上的最新版 Aider'],
          ['--user-input-color', '<color>', 'Set the user input color', '设置用户输入颜色'],
          ['--verify-ssl', undefined, 'Verify TLS certificates when connecting to model APIs', '连接模型 API 时校验 TLS 证书'],
          ['--verbose', undefined, 'Enable verbose output', '启用详细运行日志'],
          ['--voice-format', '<format>', 'Choose the recorded voice format', '设置语音录制格式'],
          ['--voice-input-device', '<device>', 'Choose the voice input device', '选择语音输入设备'],
          ['--voice-language', '<language>', 'Choose the speech-recognition language', '设置语音识别语言'],
          ['--help', undefined, 'Show command-line help and exit', '显示命令行帮助并退出', ['-h']],
        ]),
      ],
    },
    {
